...
import fontFace from "three/examples/fonts/helvetiker_regular.typeface.json";
...
function addSceneElements() {
    ...
    loader.load(coinFile, function (collada) {
        coin = collada.scene;
        coin.position.set(scoreCounter.position.x + 2, 10, scoreCounter.position.z);
        // scene.add(coin);
...
function addFellows() {
    ...
    loader.load(mushroomFile, function (collada) {
        ...
        mushroom.position.set(scoreCounter.position.x, 8, scoreCounter.position.z);
        scene.add(mushroom);
    });
}
...
function addEnemies() {
    ...
    loader.load(goombaFile, function (collada) {
        ...
        goomba.position.set(scoreCounter.position.x + 2, 8, scoreCounter.position.z);
        scene.add(goomba);
