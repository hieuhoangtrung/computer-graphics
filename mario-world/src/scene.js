...
const animate = ({ camera, clock, renderer, stats, scene , labelRenderer, dirLight, sun , score}, worldObject) => 
{
    requestAnimationFrame(() => animate({ 
      camera, clock, renderer, stats, scene, labelRenderer, dirLight, sun , score
    }, worldObject));
  ...
  //call the func updateScore to change the score
  score += 1;
...
//return the score for resue next time
